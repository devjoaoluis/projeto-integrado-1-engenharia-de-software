...
function CadastrarImovel() {
    ...
    function handleSubmit(e) {
        ...
        const imovel = {
            ...dados,
            valorAluguel: Number(dados.valorAluguel),
            valorIptu: dados.valorIptu === "" ? null : Number(dados.valorIptu),
        };
        const arquivos = [...fotos, ...videos].map((m) => m.file);

        // ------------------------------------------------------------------
        // TODO (backend): ligar aqui.
        // - Hoje o properties:create só aceita title, address, description e price.
        //   Faltam: bairro, numero, complemento, tipo, valorIptu,
        //   situacaoFiscal, situacaoSaneamento e dataCadastro.
        // - Depois de criar o imóvel, enviar cada arquivo com
        //   window.api.propertyMedia.add({ propertyId, sourceFilePath }).
        // ------------------------------------------------------------------
        console.log("Imóvel:", imovel);
        console.log("Arquivos:", arquivos);

        alert("Dados prontos! Falta ligar ao backend.");
        navigate("/imoveis");
    }
